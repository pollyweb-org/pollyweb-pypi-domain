...
class MSG(STRUCT):
    ...
    * MSG(${}) -> ${}
    ...
    def RequireSubject(self, subject=None) -> str:
        ...
        * m=${}; m.Subject(x); -> Untested behaviour!
        '''
        return self.RequireHeader().RequireStr('Subject', set=subject)

    def RequireFrom(self, set: str = None, default: str = None) -> str:
    ...
    def RequireTo(self, set: str = None) -> str:
        ''' 👉 Gets or sets the To. '''
        return self.RequireHeader().RequireStr('To', set=set)

    def GetTimestamp(self, set: str = None) -> str:
        ''' 👉 Gets or sets the Timestamp. '''
        return self.RequireHeader().RequireTimestamp('SentAt', set=set)

    def RequireCorrelation(self, set: str = None) -> str:
        ''' 👉 Gets or sets the Correlation. '''
        return self.RequireHeader().RequireUUID('Correlation', set=set)
    ...
    def RequireSignature(self, set: str = None) -> str:
        ''' 👉 Gets or sets the Signature. '''
        return self.RequireStr('Signature', set=set)

    def RequireHash(self, set: str = None) -> str:
    ...
    def MatchSubject(self, subject: str, msg: str = None, ignoreTo: bool = False, expectedTo: str = None):
